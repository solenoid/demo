...
let xPos = 0
let yPos = 0
plan.forEach(({ dir, count, color }) => {
  for (let i = 0; i < count; i++) {
    console.log(`move ${dir} on step ${i}`)
    if (dir === 'U') {
      yPos--
    }
    if (dir === 'R') {
    ...
    outline.push({ x: xPos, y: yPos, color })
  }
})
const minX = Math.min(...outline.map((d) => d.x))
